function [out]=Plot3dSymbolFC2(data1,data2,x,y,z,col1,col2)
% Plot3dSymbolFC2(SKnownEx2.PCAscores1,SKnownEx2.PCAscores2,1,2,3,MKnownEx2.Colour1,MKnownEx2.Colour2);
...
for i=1
plot3(data1(i,x),data1(i,y),data1(i,z),'^','MarkerFaceColor',bob1(i,:),'MarkerEdgeColor',bob1(i,:),'MarkerSize',10);
end
hold;
...
for i=1:rr
plot3(data2(i,x),data2(i,y),data1(i,z),'^','MarkerEdgeColor',bob2(i,:),'MarkerSize',10);
end
